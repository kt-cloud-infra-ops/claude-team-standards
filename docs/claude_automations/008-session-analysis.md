...
```bash
# 프로젝트 repo에서 수정
vim /Users/jiwoong.kim/Documents/claude/.claude/rules/doc-organization.md

# 홈 디렉토리로 복사
cp /Users/jiwoong.kim/Documents/claude/.claude/rules/doc-organization.md \
...
RULES_SOURCE="$HOME/Documents/claude/.claude/rules"
RULES_HOME="$HOME/.claude/rules"
...
ln -s ~/Documents/claude/.claude/rules ~/.claude/rules-project
```
...
- **자동화 제안**: `/Users/jiwoong.kim/Documents/claude/docs/automations/006-cross-reference-rules-automation.md`
- **규칙 디렉토리**: `~/.claude/rules/` (개인)
- **프로젝트 규칙**: `/Users/jiwoong.kim/Documents/claude/.claude/rules/` (repo)
