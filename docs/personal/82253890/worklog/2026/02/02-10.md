...
- **(POC)** Claude Code 문서 표준화 — 추후 에픽/태스크 전환 예정
  ...
  - `.agents/rules/doc-organization.md`에 Obsidian 태그 규칙 추가
- **(티켓 없음)** 인프라 인벤토리 정리
...
- `docs/lessons_learned/java/code-review-traps.md` — 신규
- `docs/lessons_learned/java/mybatis-sql-patterns.md` — 신규
- `docs/lessons_learned/common/mcp-tools-guide.md` — ADF 프로젝트 타입별 차이 추가
